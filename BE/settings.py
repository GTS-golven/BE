...
SECRET_KEY = 'django-insecure-cj4lr8ua-l8#7%#c!*$gy5xyfh^shhf4mr5srxwwiq!4wh&9t@'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'VideoApi')
MEDIA_URL = '/VideoApi/'
MEDIA_FILES_DIRS = os.path.join(BASE_DIR, 'VideoApi')
